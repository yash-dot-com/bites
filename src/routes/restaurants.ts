...
import { bloomKey } from "../utils/redisKeys.js";
...
// restaurantDetails is the schema against which the incoming data is getting validated
router.post(
...
// POST /restaurants
// bloom filters are used to check if a username is already taken, fast transaction search etc
...
router.post("/", validate(RestaurantSchema), async (req, res, next) => {
  ...
  try {
    ...
    // bloom filter for checking if the restaurant already exists
